...
model_file = "BG6970316SK--3 JELLY BELT BAG (3).glb"
...
def convert_camera_location(threejs_location):
    ...
    return (threejs_location[0], -threejs_location[2], threejs_location[1] + 10)
...
def main(camera_location, camera_rotation, frustum_width, frustum_height, target_name):
...
if __name__ == "__main__":
    ...
    main((camera_location),
         (camera_rotation), 20, 20, target_name)
